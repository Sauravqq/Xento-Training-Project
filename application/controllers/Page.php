    ...
    function contact() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $config = Array(
                ...
                'smtp_port' => 465,
                'smtp_user' => 'YOUR_EMAIL_ADDRESS', // please replace this with yours 
                'smtp_pass' => 'YOUR_PASSWORD', // please replace this with yours
                'mailtype'  => 'html',
                'charset'   => 'iso-8859-1'
            );
            ...
            $this->email->to('REPLACE_WITH_YOUR_EMAIL_ADDRESS'); // This is an email where you want to receive email
            $this->email->from('example@example.com'); // This is from email address 
